...
TEST(statementIntegration, testReturnForOneRentals) {
	Customer c;
	c.addRental(std::shared_ptr<Rental>(new Rental(std::shared_ptr<Movie>(new Movie("Avatar", std::shared_ptr<MoviePriceCode>(new Regular()))),10)));
	string statement = c.statement();
...
TEST(statementIntegration, testReturnForManyRentalsWithDifferentPriceCode) {
	Customer c;
	c.addRental(std::shared_ptr<Rental>(new Rental(std::shared_ptr<Movie>(new Movie("Shrek", std::shared_ptr<MoviePriceCode>(new Children()))),8)));
	c.addRental(std::shared_ptr<Rental>(new Rental(std::shared_ptr<Movie>(new Movie("Inception", std::shared_ptr<MoviePriceCode>(new Regular()))),12)));
	c.addRental(std::shared_ptr<Rental>(new Rental(std::shared_ptr<Movie>(new Movie("Avatar2", std::shared_ptr<MoviePriceCode>(new NewRelease()))),20)));
	string statement = c.statement();
